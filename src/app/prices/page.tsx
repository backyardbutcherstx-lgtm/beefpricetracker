...
export default async function PricesPage() {
  ...
  return (
    <div className="max-w-[1100px] mx-auto px-10 py-12">
      <h1 className="text-3xl font-bold text-navy mb-2">Live Beef Prices</h1>
              ...
              <tbody>
                {data
                  ...
                  .map((point, idx) => {
                    ...
                    const prev =
                      prevIdx >= 0 ? data[prevIdx]?.value : point.value;
      ...
      <div className="bg-muted rounded-lg p-6 mt-8">
        <h3 className="font-semibold text-navy mb-2">About This Data</h3>
